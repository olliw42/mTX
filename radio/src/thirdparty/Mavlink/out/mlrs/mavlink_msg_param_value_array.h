...
typedef struct _fmav_param_value_array_t {
    ...
    uint16_t param_array_len;
    uint16_t flags;
    uint8_t packet_buf[247];
...
#define FASTMAVLINK_MSG_PARAM_VALUE_ARRAY_CRCEXTRA  76
...
#define FASTMAVLINK_MSG_PARAM_VALUE_ARRAY_FIELD_PACKET_BUF_NUM  247 // number of elements in array
#define FASTMAVLINK_MSG_PARAM_VALUE_ARRAY_FIELD_PACKET_BUF_LEN  247 // length of array = number of bytes
...
#define FASTMAVLINK_MSG_PARAM_VALUE_ARRAY_FIELD_PARAM_ARRAY_LEN_OFS  4
#define FASTMAVLINK_MSG_PARAM_VALUE_ARRAY_FIELD_FLAGS_OFS  6
#define FASTMAVLINK_MSG_PARAM_VALUE_ARRAY_FIELD_PACKET_BUF_OFS  8
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_param_value_array_pack(
    ...
    uint8_t sysid,
    uint8_t compid,
    uint16_t param_count, uint16_t param_index_first, uint16_t param_array_len, uint16_t flags, const uint8_t* packet_buf,
    fmav_status_t* _status)
{
    ...
    memcpy(&(_payload->packet_buf), packet_buf, sizeof(uint8_t)*247);
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_param_value_array_get_field_param_array_len(const fmav_message_t* msg)
{
    uint16_t r;
...
#define MAVLINK_MSG_ID_PARAM_VALUE_ARRAY_CRC  76
#define MAVLINK_MSG_ID_60041_CRC  76

#define MAVLINK_MSG_PARAM_VALUE_ARRAY_FIELD_PACKET_BUF_LEN 247
