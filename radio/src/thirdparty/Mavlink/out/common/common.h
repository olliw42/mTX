...
#pragma once
#ifndef FASTMAVLINK_COMMON_H
#define FASTMAVLINK_COMMON_H
...
#ifndef FASTMAVLINK_HAS_ENUM_HL_FAILURE_FLAG
#define FASTMAVLINK_HAS_ENUM_HL_FAILURE_FLAG
typedef enum HL_FAILURE_FLAG {
    ...
    HL_FAILURE_FLAG_ENUM_END = 8193,  // end marker
} HL_FAILURE_FLAG;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_GOTO
#define FASTMAVLINK_HAS_ENUM_MAV_GOTO
typedef enum MAV_GOTO {
    MAV_GOTO_DO_HOLD = 0,  // Hold at the current position. 
    MAV_GOTO_DO_CONTINUE = 1,  // Continue with the next item in mission execution. 
    MAV_GOTO_HOLD_AT_CURRENT_POSITION = 2,  // Hold at the current position of the system 
    MAV_GOTO_HOLD_AT_SPECIFIED_POSITION = 3,  // Hold at the position specified in the parameters of the DO_HOLD action 
    MAV_GOTO_ENUM_END = 4,  // end marker
} MAV_GOTO;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_MODE
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_FRAME
#define FASTMAVLINK_HAS_ENUM_MAV_FRAME
typedef enum MAV_FRAME {
    ...
    MAV_FRAME_ENUM_END = 22,  // end marker
} MAV_FRAME;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAVLINK_DATA_STREAM_TYPE
#define FASTMAVLINK_HAS_ENUM_MAVLINK_DATA_STREAM_TYPE
typedef enum MAVLINK_DATA_STREAM_TYPE {
    ...
    MAVLINK_DATA_STREAM_TYPE_ENUM_END = 6,  // end marker
...
#ifndef FASTMAVLINK_HAS_ENUM_FENCE_BREACH
#define FASTMAVLINK_HAS_ENUM_FENCE_BREACH
typedef enum FENCE_BREACH {
    FENCE_BREACH_NONE = 0,  // No last fence breach 
    FENCE_BREACH_MINALT = 1,  // Breached minimum altitude 
    FENCE_BREACH_MAXALT = 2,  // Breached maximum altitude 
    FENCE_BREACH_BOUNDARY = 3,  // Breached fence boundary 
    FENCE_BREACH_ENUM_END = 4,  // end marker
} FENCE_BREACH;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_FENCE_MITIGATE
#define FASTMAVLINK_HAS_ENUM_FENCE_MITIGATE
typedef enum FENCE_MITIGATE {
    ...
    FENCE_MITIGATE_ENUM_END = 3,  // end marker
} FENCE_MITIGATE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_MOUNT_MODE
#define FASTMAVLINK_HAS_ENUM_MAV_MOUNT_MODE
...
typedef enum GIMBAL_DEVICE_CAP_FLAGS {
    ...
    GIMBAL_DEVICE_CAP_FLAGS_ENUM_END = 8193,  // end marker
} GIMBAL_DEVICE_CAP_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_GIMBAL_MANAGER_CAP_FLAGS
#define FASTMAVLINK_HAS_ENUM_GIMBAL_MANAGER_CAP_FLAGS
...
#ifndef FASTMAVLINK_HAS_ENUM_GIMBAL_DEVICE_FLAGS
...
typedef enum GIMBAL_DEVICE_FLAGS {
    ...
    GIMBAL_DEVICE_FLAGS_ENUM_END = 513,  // end marker
} GIMBAL_DEVICE_FLAGS;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_GIMBAL_DEVICE_ERROR_FLAGS
#define FASTMAVLINK_HAS_ENUM_GIMBAL_DEVICE_ERROR_FLAGS
typedef enum GIMBAL_DEVICE_ERROR_FLAGS {
    ...
    GIMBAL_DEVICE_ERROR_FLAGS_ENUM_END = 513,  // end marker
} GIMBAL_DEVICE_ERROR_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_GRIPPER_ACTIONS
#define FASTMAVLINK_HAS_ENUM_GRIPPER_ACTIONS
typedef enum GRIPPER_ACTIONS {
    GRIPPER_ACTION_RELEASE = 0,  // Gripper release cargo. 
    GRIPPER_ACTION_GRAB = 1,  // Gripper grab onto cargo. 
    GRIPPER_ACTIONS_ENUM_END = 2,  // end marker
} GRIPPER_ACTIONS;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_UAVCAN_NODE_HEALTH
#define FASTMAVLINK_HAS_ENUM_UAVCAN_NODE_HEALTH
typedef enum UAVCAN_NODE_HEALTH {
    ...
    UAVCAN_NODE_HEALTH_ENUM_END = 4,  // end marker
} UAVCAN_NODE_HEALTH;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_UAVCAN_NODE_MODE
#define FASTMAVLINK_HAS_ENUM_UAVCAN_NODE_MODE
typedef enum UAVCAN_NODE_MODE {
    ...
    UAVCAN_NODE_MODE_ENUM_END = 8,  // end marker
} UAVCAN_NODE_MODE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ESC_CONNECTION_TYPE
#define FASTMAVLINK_HAS_ENUM_ESC_CONNECTION_TYPE
typedef enum ESC_CONNECTION_TYPE {
    ...
    ESC_CONNECTION_TYPE_ENUM_END = 6,  // end marker
} ESC_CONNECTION_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ESC_FAILURE_FLAGS
#define FASTMAVLINK_HAS_ENUM_ESC_FAILURE_FLAGS
typedef enum ESC_FAILURE_FLAGS {
    ...
    ESC_FAILURE_FLAGS_ENUM_END = 65,  // end marker
} ESC_FAILURE_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_STORAGE_STATUS
#define FASTMAVLINK_HAS_ENUM_STORAGE_STATUS
typedef enum STORAGE_STATUS {
    ...
    STORAGE_STATUS_ENUM_END = 4,  // end marker
} STORAGE_STATUS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_STORAGE_TYPE
#define FASTMAVLINK_HAS_ENUM_STORAGE_TYPE
typedef enum STORAGE_TYPE {
    ...
    STORAGE_TYPE_ENUM_END = 255,  // end marker
} STORAGE_TYPE;
#endif
...
typedef enum STORAGE_USAGE_FLAG {
    ...
    STORAGE_USAGE_FLAG_ENUM_END = 9,  // end marker
} STORAGE_USAGE_FLAG;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ORBIT_YAW_BEHAVIOUR
#define FASTMAVLINK_HAS_ENUM_ORBIT_YAW_BEHAVIOUR
typedef enum ORBIT_YAW_BEHAVIOUR {
    ...
    ORBIT_YAW_BEHAVIOUR_ENUM_END = 5,  // end marker
} ORBIT_YAW_BEHAVIOUR;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_WIFI_CONFIG_AP_RESPONSE
#define FASTMAVLINK_HAS_ENUM_WIFI_CONFIG_AP_RESPONSE
typedef enum WIFI_CONFIG_AP_RESPONSE {
    ...
    WIFI_CONFIG_AP_RESPONSE_ENUM_END = 6,  // end marker
} WIFI_CONFIG_AP_RESPONSE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CELLULAR_CONFIG_RESPONSE
#define FASTMAVLINK_HAS_ENUM_CELLULAR_CONFIG_RESPONSE
typedef enum CELLULAR_CONFIG_RESPONSE {
    ...
    CELLULAR_CONFIG_RESPONSE_ENUM_END = 5,  // end marker
} CELLULAR_CONFIG_RESPONSE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_WIFI_CONFIG_AP_MODE
#define FASTMAVLINK_HAS_ENUM_WIFI_CONFIG_AP_MODE
typedef enum WIFI_CONFIG_AP_MODE {
    ...
    WIFI_CONFIG_AP_MODE_ENUM_END = 4,  // end marker
} WIFI_CONFIG_AP_MODE;
#endif
...
typedef enum MAV_CMD {
    ...
    MAV_CMD_RUN_PREARM_CHECKS = 401,  // Instructs a target system to run pre-arm checks.          This allows preflight checks to be run on demand, which may be useful on systems that normally run them at low rate, or which do not trigger checks when the armable state might have changed.          This command should return MAV_RESULT_ACCEPTED if it will run the checks.          The results of the checks are usually then reported in SYS_STATUS messages (this is system-specific).          The command should return MAV_RESULT_TEMPORARILY_REJECTED if the system is already armed.         | Reserved (default:0) | Reserved (default:0) | Reserved (default:0) | Reserved (default:0) | Reserved (default:0) | Reserved (default:0) | Reserved (default:0)
    ...
    MAV_CMD_ENUM_END = 43004,  // end marker
} MAV_CMD;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_DATA_STREAM
#define FASTMAVLINK_HAS_ENUM_MAV_DATA_STREAM
typedef enum MAV_DATA_STREAM {
    ...
    MAV_DATA_STREAM_ENUM_END = 13,  // end marker
} MAV_DATA_STREAM;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ROI
#define FASTMAVLINK_HAS_ENUM_MAV_ROI
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_PARAM_EXT_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_PARAM_EXT_TYPE
typedef enum MAV_PARAM_EXT_TYPE {
    ...
    MAV_PARAM_EXT_TYPE_ENUM_END = 12,  // end marker
} MAV_PARAM_EXT_TYPE;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_MISSION_RESULT
#define FASTMAVLINK_HAS_ENUM_MAV_MISSION_RESULT
typedef enum MAV_MISSION_RESULT {
    ...
    MAV_MISSION_RESULT_ENUM_END = 16,  // end marker
} MAV_MISSION_RESULT;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_POWER_STATUS
#define FASTMAVLINK_HAS_ENUM_MAV_POWER_STATUS
typedef enum MAV_POWER_STATUS {
    ...
    MAV_POWER_STATUS_ENUM_END = 33,  // end marker
} MAV_POWER_STATUS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_SERIAL_CONTROL_DEV
#define FASTMAVLINK_HAS_ENUM_SERIAL_CONTROL_DEV
typedef enum SERIAL_CONTROL_DEV {
    ...
    SERIAL_CONTROL_DEV_ENUM_END = 110,  // end marker
} SERIAL_CONTROL_DEV;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_SERIAL_CONTROL_FLAG
#define FASTMAVLINK_HAS_ENUM_SERIAL_CONTROL_FLAG
typedef enum SERIAL_CONTROL_FLAG {
    ...
    SERIAL_CONTROL_FLAG_ENUM_END = 17,  // end marker
} SERIAL_CONTROL_FLAG;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_DISTANCE_SENSOR
#define FASTMAVLINK_HAS_ENUM_MAV_DISTANCE_SENSOR
typedef enum MAV_DISTANCE_SENSOR {
    ...
    MAV_DISTANCE_SENSOR_ENUM_END = 5,  // end marker
} MAV_DISTANCE_SENSOR;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_SENSOR_ORIENTATION
#define FASTMAVLINK_HAS_ENUM_MAV_SENSOR_ORIENTATION
typedef enum MAV_SENSOR_ORIENTATION {
    ...
    MAV_SENSOR_ORIENTATION_ENUM_END = 101,  // end marker
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_MISSION_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_MISSION_TYPE
typedef enum MAV_MISSION_TYPE {
    ...
    MAV_MISSION_TYPE_ENUM_END = 256,  // end marker
} MAV_MISSION_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ESTIMATOR_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_ESTIMATOR_TYPE
typedef enum MAV_ESTIMATOR_TYPE {
    ...
    MAV_ESTIMATOR_TYPE_ENUM_END = 9,  // end marker
} MAV_ESTIMATOR_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_BATTERY_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_BATTERY_TYPE
typedef enum MAV_BATTERY_TYPE {
    ...
    MAV_BATTERY_TYPE_ENUM_END = 5,  // end marker
} MAV_BATTERY_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_BATTERY_FUNCTION
#define FASTMAVLINK_HAS_ENUM_MAV_BATTERY_FUNCTION
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_BATTERY_CHARGE_STATE
#define FASTMAVLINK_HAS_ENUM_MAV_BATTERY_CHARGE_STATE
typedef enum MAV_BATTERY_CHARGE_STATE {
    ...
    MAV_BATTERY_CHARGE_STATE_ENUM_END = 8,  // end marker
} MAV_BATTERY_CHARGE_STATE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_BATTERY_MODE
#define FASTMAVLINK_HAS_ENUM_MAV_BATTERY_MODE
typedef enum MAV_BATTERY_MODE {
    ...
    MAV_BATTERY_MODE_ENUM_END = 3,  // end marker
} MAV_BATTERY_MODE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_BATTERY_FAULT
#define FASTMAVLINK_HAS_ENUM_MAV_BATTERY_FAULT
typedef enum MAV_BATTERY_FAULT {
    ...
    MAV_BATTERY_FAULT_ENUM_END = 257,  // end marker
} MAV_BATTERY_FAULT;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_GENERATOR_STATUS_FLAG
#define FASTMAVLINK_HAS_ENUM_MAV_GENERATOR_STATUS_FLAG
typedef enum MAV_GENERATOR_STATUS_FLAG {
    ...
    MAV_GENERATOR_STATUS_FLAG_ENUM_END = 4194305,  // end marker
} MAV_GENERATOR_STATUS_FLAG;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_VTOL_STATE
#define FASTMAVLINK_HAS_ENUM_MAV_VTOL_STATE
typedef enum MAV_VTOL_STATE {
    ...
    MAV_VTOL_STATE_ENUM_END = 5,  // end marker
} MAV_VTOL_STATE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_LANDED_STATE
#define FASTMAVLINK_HAS_ENUM_MAV_LANDED_STATE
typedef enum MAV_LANDED_STATE {
    ...
    MAV_LANDED_STATE_ENUM_END = 5,  // end marker
} MAV_LANDED_STATE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ADSB_ALTITUDE_TYPE
#define FASTMAVLINK_HAS_ENUM_ADSB_ALTITUDE_TYPE
typedef enum ADSB_ALTITUDE_TYPE {
    ...
    ADSB_ALTITUDE_TYPE_ENUM_END = 2,  // end marker
} ADSB_ALTITUDE_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ADSB_EMITTER_TYPE
#define FASTMAVLINK_HAS_ENUM_ADSB_EMITTER_TYPE
typedef enum ADSB_EMITTER_TYPE {
    ...
    ADSB_EMITTER_TYPE_ENUM_END = 20,  // end marker
} ADSB_EMITTER_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ADSB_FLAGS
#define FASTMAVLINK_HAS_ENUM_ADSB_FLAGS
typedef enum ADSB_FLAGS {
    ...
    ADSB_FLAGS_ENUM_END = 32769,  // end marker
} ADSB_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_DO_REPOSITION_FLAGS
#define FASTMAVLINK_HAS_ENUM_MAV_DO_REPOSITION_FLAGS
typedef enum MAV_DO_REPOSITION_FLAGS {
    ...
    MAV_DO_REPOSITION_FLAGS_ENUM_END = 2,  // end marker
...
typedef enum SPEED_TYPE {
    ...
    SPEED_TYPE_ENUM_END = 4,  // end marker
} SPEED_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ESTIMATOR_STATUS_FLAGS
#define FASTMAVLINK_HAS_ENUM_ESTIMATOR_STATUS_FLAGS
typedef enum ESTIMATOR_STATUS_FLAGS {
    ...
    ESTIMATOR_STATUS_FLAGS_ENUM_END = 2049,  // end marker
} ESTIMATOR_STATUS_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MOTOR_TEST_ORDER
#define FASTMAVLINK_HAS_ENUM_MOTOR_TEST_ORDER
typedef enum MOTOR_TEST_ORDER {
    ...
    MOTOR_TEST_ORDER_ENUM_END = 3,  // end marker
} MOTOR_TEST_ORDER;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MOTOR_TEST_THROTTLE_TYPE
#define FASTMAVLINK_HAS_ENUM_MOTOR_TEST_THROTTLE_TYPE
typedef enum MOTOR_TEST_THROTTLE_TYPE {
    ...
    MOTOR_TEST_THROTTLE_TYPE_ENUM_END = 4,  // end marker
} MOTOR_TEST_THROTTLE_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_GPS_INPUT_IGNORE_FLAGS
#define FASTMAVLINK_HAS_ENUM_GPS_INPUT_IGNORE_FLAGS
typedef enum GPS_INPUT_IGNORE_FLAGS {
    ...
    GPS_INPUT_IGNORE_FLAGS_ENUM_END = 129,  // end marker
} GPS_INPUT_IGNORE_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_COLLISION_ACTION
#define FASTMAVLINK_HAS_ENUM_MAV_COLLISION_ACTION
typedef enum MAV_COLLISION_ACTION {
    ...
    MAV_COLLISION_ACTION_ENUM_END = 7,  // end marker
} MAV_COLLISION_ACTION;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_COLLISION_THREAT_LEVEL
#define FASTMAVLINK_HAS_ENUM_MAV_COLLISION_THREAT_LEVEL
typedef enum MAV_COLLISION_THREAT_LEVEL {
    ...
    MAV_COLLISION_THREAT_LEVEL_ENUM_END = 3,  // end marker
} MAV_COLLISION_THREAT_LEVEL;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_COLLISION_SRC
#define FASTMAVLINK_HAS_ENUM_MAV_COLLISION_SRC
typedef enum MAV_COLLISION_SRC {
    ...
    MAV_COLLISION_SRC_ENUM_END = 2,  // end marker
} MAV_COLLISION_SRC;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_GPS_FIX_TYPE
#define FASTMAVLINK_HAS_ENUM_GPS_FIX_TYPE
typedef enum GPS_FIX_TYPE {
    ...
    GPS_FIX_TYPE_ENUM_END = 9,  // end marker
} GPS_FIX_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_RTK_BASELINE_COORDINATE_SYSTEM
#define FASTMAVLINK_HAS_ENUM_RTK_BASELINE_COORDINATE_SYSTEM
typedef enum RTK_BASELINE_COORDINATE_SYSTEM {
    ...
    RTK_BASELINE_COORDINATE_SYSTEM_ENUM_END = 2,  // end marker
} RTK_BASELINE_COORDINATE_SYSTEM;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_LANDING_TARGET_TYPE
#define FASTMAVLINK_HAS_ENUM_LANDING_TARGET_TYPE
typedef enum LANDING_TARGET_TYPE {
    ...
    LANDING_TARGET_TYPE_ENUM_END = 4,  // end marker
} LANDING_TARGET_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_VTOL_TRANSITION_HEADING
#define FASTMAVLINK_HAS_ENUM_VTOL_TRANSITION_HEADING
typedef enum VTOL_TRANSITION_HEADING {
    ...
    VTOL_TRANSITION_HEADING_ENUM_END = 5,  // end marker
} VTOL_TRANSITION_HEADING;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CAMERA_CAP_FLAGS
#define FASTMAVLINK_HAS_ENUM_CAMERA_CAP_FLAGS
typedef enum CAMERA_CAP_FLAGS {
    ...
    CAMERA_CAP_FLAGS_ENUM_END = 2049,  // end marker
} CAMERA_CAP_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_VIDEO_STREAM_STATUS_FLAGS
#define FASTMAVLINK_HAS_ENUM_VIDEO_STREAM_STATUS_FLAGS
typedef enum VIDEO_STREAM_STATUS_FLAGS {
    ...
    VIDEO_STREAM_STATUS_FLAGS_ENUM_END = 3,  // end marker
} VIDEO_STREAM_STATUS_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_VIDEO_STREAM_TYPE
#define FASTMAVLINK_HAS_ENUM_VIDEO_STREAM_TYPE
typedef enum VIDEO_STREAM_TYPE {
    ...
    VIDEO_STREAM_TYPE_ENUM_END = 4,  // end marker
} VIDEO_STREAM_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CAMERA_TRACKING_STATUS_FLAGS
#define FASTMAVLINK_HAS_ENUM_CAMERA_TRACKING_STATUS_FLAGS
typedef enum CAMERA_TRACKING_STATUS_FLAGS {
    ...
    CAMERA_TRACKING_STATUS_FLAGS_ENUM_END = 3,  // end marker
} CAMERA_TRACKING_STATUS_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CAMERA_TRACKING_MODE
#define FASTMAVLINK_HAS_ENUM_CAMERA_TRACKING_MODE
typedef enum CAMERA_TRACKING_MODE {
    ...
    CAMERA_TRACKING_MODE_ENUM_END = 3,  // end marker
} CAMERA_TRACKING_MODE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CAMERA_TRACKING_TARGET_DATA
#define FASTMAVLINK_HAS_ENUM_CAMERA_TRACKING_TARGET_DATA
typedef enum CAMERA_TRACKING_TARGET_DATA {
    ...
    CAMERA_TRACKING_TARGET_DATA_ENUM_END = 5,  // end marker
} CAMERA_TRACKING_TARGET_DATA;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CAMERA_ZOOM_TYPE
#define FASTMAVLINK_HAS_ENUM_CAMERA_ZOOM_TYPE
typedef enum CAMERA_ZOOM_TYPE {
    ...
    CAMERA_ZOOM_TYPE_ENUM_END = 5,  // end marker
} CAMERA_ZOOM_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_SET_FOCUS_TYPE
#define FASTMAVLINK_HAS_ENUM_SET_FOCUS_TYPE
...
#ifndef FASTMAVLINK_HAS_ENUM_PARAM_ACK
#define FASTMAVLINK_HAS_ENUM_PARAM_ACK
typedef enum PARAM_ACK {
    ...
    PARAM_ACK_ENUM_END = 4,  // end marker
} PARAM_ACK;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_CAMERA_MODE
#define FASTMAVLINK_HAS_ENUM_CAMERA_MODE
typedef enum CAMERA_MODE {
    ...
    CAMERA_MODE_ENUM_END = 3,  // end marker
} CAMERA_MODE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ARM_AUTH_DENIED_REASON
#define FASTMAVLINK_HAS_ENUM_MAV_ARM_AUTH_DENIED_REASON
typedef enum MAV_ARM_AUTH_DENIED_REASON {
    ...
    MAV_ARM_AUTH_DENIED_REASON_ENUM_END = 6,  // end marker
} MAV_ARM_AUTH_DENIED_REASON;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_RC_TYPE
#define FASTMAVLINK_HAS_ENUM_RC_TYPE
typedef enum RC_TYPE {
    RC_TYPE_SPEKTRUM_DSM2 = 0,  // Spektrum DSM2 
    RC_TYPE_SPEKTRUM_DSMX = 1,  // Spektrum DSMX 
    RC_TYPE_ENUM_END = 2,  // end marker
} RC_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_POSITION_TARGET_TYPEMASK
#define FASTMAVLINK_HAS_ENUM_POSITION_TARGET_TYPEMASK
typedef enum POSITION_TARGET_TYPEMASK {
    ...
    POSITION_TARGET_TYPEMASK_ENUM_END = 2049,  // end marker
} POSITION_TARGET_TYPEMASK;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_ATTITUDE_TARGET_TYPEMASK
#define FASTMAVLINK_HAS_ENUM_ATTITUDE_TARGET_TYPEMASK
typedef enum ATTITUDE_TARGET_TYPEMASK {
    ...
    ATTITUDE_TARGET_TYPEMASK_ENUM_END = 129,  // end marker
} ATTITUDE_TARGET_TYPEMASK;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_UTM_FLIGHT_STATE
#define FASTMAVLINK_HAS_ENUM_UTM_FLIGHT_STATE
typedef enum UTM_FLIGHT_STATE {
    ...
    UTM_FLIGHT_STATE_ENUM_END = 33,  // end marker
} UTM_FLIGHT_STATE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_UTM_DATA_AVAIL_FLAGS
#define FASTMAVLINK_HAS_ENUM_UTM_DATA_AVAIL_FLAGS
typedef enum UTM_DATA_AVAIL_FLAGS {
    ...
    UTM_DATA_AVAIL_FLAGS_ENUM_END = 129,  // end marker
...
typedef enum PRECISION_LAND_MODE {
    ...
    PRECISION_LAND_MODE_ENUM_END = 3,  // end marker
} PRECISION_LAND_MODE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_PARACHUTE_ACTION
#define FASTMAVLINK_HAS_ENUM_PARACHUTE_ACTION
typedef enum PARACHUTE_ACTION {
    ...
    PARACHUTE_ACTION_ENUM_END = 3,  // end marker
} PARACHUTE_ACTION;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_TUNNEL_PAYLOAD_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_TUNNEL_PAYLOAD_TYPE
typedef enum MAV_TUNNEL_PAYLOAD_TYPE {
    ...
    MAV_TUNNEL_PAYLOAD_TYPE_ENUM_END = 210,  // end marker
} MAV_TUNNEL_PAYLOAD_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_ID_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_ID_TYPE
typedef enum MAV_ODID_ID_TYPE {
    ...
    MAV_ODID_ID_TYPE_ENUM_END = 5,  // end marker
} MAV_ODID_ID_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_UA_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_UA_TYPE
typedef enum MAV_ODID_UA_TYPE {
    ...
    MAV_ODID_UA_TYPE_ENUM_END = 16,  // end marker
} MAV_ODID_UA_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_STATUS
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_STATUS
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_HEIGHT_REF
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_HEIGHT_REF
typedef enum MAV_ODID_HEIGHT_REF {
    ...
    MAV_ODID_HEIGHT_REF_ENUM_END = 2,  // end marker
} MAV_ODID_HEIGHT_REF;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_HOR_ACC
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_HOR_ACC
typedef enum MAV_ODID_HOR_ACC {
    ...
    MAV_ODID_HOR_ACC_ENUM_END = 13,  // end marker
} MAV_ODID_HOR_ACC;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_VER_ACC
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_VER_ACC
typedef enum MAV_ODID_VER_ACC {
    ...
    MAV_ODID_VER_ACC_ENUM_END = 7,  // end marker
} MAV_ODID_VER_ACC;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_SPEED_ACC
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_SPEED_ACC
typedef enum MAV_ODID_SPEED_ACC {
    ...
    MAV_ODID_SPEED_ACC_ENUM_END = 5,  // end marker
} MAV_ODID_SPEED_ACC;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_TIME_ACC
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_TIME_ACC
typedef enum MAV_ODID_TIME_ACC {
    ...
    MAV_ODID_TIME_ACC_ENUM_END = 16,  // end marker
} MAV_ODID_TIME_ACC;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_AUTH_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_AUTH_TYPE
typedef enum MAV_ODID_AUTH_TYPE {
    ...
    MAV_ODID_AUTH_TYPE_ENUM_END = 6,  // end marker
} MAV_ODID_AUTH_TYPE;
#endif
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_CLASSIFICATION_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_CLASSIFICATION_TYPE
typedef enum MAV_ODID_CLASSIFICATION_TYPE {
    ...
    MAV_ODID_CLASSIFICATION_TYPE_ENUM_END = 2,  // end marker
} MAV_ODID_CLASSIFICATION_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_CATEGORY_EU
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_CATEGORY_EU
typedef enum MAV_ODID_CATEGORY_EU {
    ...
    MAV_ODID_CATEGORY_EU_ENUM_END = 4,  // end marker
} MAV_ODID_CATEGORY_EU;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_CLASS_EU
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_CLASS_EU
typedef enum MAV_ODID_CLASS_EU {
    ...
    MAV_ODID_CLASS_EU_ENUM_END = 8,  // end marker
} MAV_ODID_CLASS_EU;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_OPERATOR_ID_TYPE
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_OPERATOR_ID_TYPE
typedef enum MAV_ODID_OPERATOR_ID_TYPE {
    ...
    MAV_ODID_OPERATOR_ID_TYPE_ENUM_END = 1,  // end marker
} MAV_ODID_OPERATOR_ID_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_MAV_ODID_ARM_STATUS
#define FASTMAVLINK_HAS_ENUM_MAV_ODID_ARM_STATUS
typedef enum MAV_ODID_ARM_STATUS {
    ...
    MAV_ODID_ARM_STATUS_ENUM_END = 2,  // end marker
} MAV_ODID_ARM_STATUS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_TUNE_FORMAT
#define FASTMAVLINK_HAS_ENUM_TUNE_FORMAT
...
#ifndef FASTMAVLINK_HAS_ENUM_AIS_TYPE
#define FASTMAVLINK_HAS_ENUM_AIS_TYPE
typedef enum AIS_TYPE {
    ...
    AIS_TYPE_ENUM_END = 100,  // end marker
} AIS_TYPE;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_AIS_NAV_STATUS
#define FASTMAVLINK_HAS_ENUM_AIS_NAV_STATUS
typedef enum AIS_NAV_STATUS {
    ...
    AIS_NAV_STATUS_ENUM_END = 16,  // end marker
} AIS_NAV_STATUS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_AIS_FLAGS
#define FASTMAVLINK_HAS_ENUM_AIS_FLAGS
typedef enum AIS_FLAGS {
    ...
    AIS_FLAGS_ENUM_END = 4097,  // end marker
} AIS_FLAGS;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_FAILURE_UNIT
#define FASTMAVLINK_HAS_ENUM_FAILURE_UNIT
typedef enum FAILURE_UNIT {
    ...
    FAILURE_UNIT_ENUM_END = 106,  // end marker
} FAILURE_UNIT;
#endif


#ifndef FASTMAVLINK_HAS_ENUM_FAILURE_TYPE
#define FASTMAVLINK_HAS_ENUM_FAILURE_TYPE
...
#ifndef FASTMAVLINK_HAS_ENUM_MAV_WINCH_STATUS_FLAG
...
#ifndef FASTMAVLINK_HAS_ENUM_MAG_CAL_STATUS
#define FASTMAVLINK_HAS_ENUM_MAG_CAL_STATUS
...
#ifndef FASTMAVLINK_HAS_ENUM_MISSION_STATE
#define FASTMAVLINK_HAS_ENUM_MISSION_STATE
typedef enum MISSION_STATE {
    ...
    MISSION_STATE_ENUM_END = 6,  // end marker
} MISSION_STATE;
#endif
