...
static_assert(sizeof(TOUCH_GT911_Cfg) == 184 * sizeof(uint8_t), "Invalid GT911 config");
...
static void dumpGT911Config(void)
{
  ...
  TRACE("Dumping GT911 Configuration");
  I2C_GT911_ReadRegister(GT_CFGS_REG, current, sizeof(TOUCH_GT911_Cfg));
