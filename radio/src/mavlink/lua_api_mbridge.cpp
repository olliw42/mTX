...
//  lua_pushtableinteger(L, "diversity", mBridge.link_stats.__diversity);

//  lua_pushtableinteger(L, "rssi1_filt", mBridge.link_stats.__rssi1_filtered);
//  lua_pushtableinteger(L, "rssi2_filt", mBridge.link_stats.__rssi2_filtered);
//  lua_pushtableinteger(L, "snr_filt", mBridge.link_stats.__snr_filtered);
...
//  lua_pushtableinteger(L, "rx_diversity", mBridge.link_stats.__receiver_diversity);

//  lua_pushtableinteger(L, "rx_rssi_filt", mBridge.link_stats.__receiver_rssi_filtered);
  ...
  lua_pushtableinteger(L, "LQ_mav_packets", mBridge.link_stats.mavlink_packet_LQ_received);
