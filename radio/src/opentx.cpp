...
void modelDefault(uint8_t id)
{
  ...
  g_model.moduleData[INTERNAL_MODULE].setType(IS_PXX2_INTERNAL_ENABLED() ? MODULE_TYPE_ISRM_PXX2 : MODULE_TYPE_XJT_PXX1);
  ...
  g_model.moduleData[INTERNAL_MODULE].setType(MODULE_TYPE_MULTIMODULE);
