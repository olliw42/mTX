...
ISTR(MAVLINK_RC_OVERRIDE_FREQUENCIES);
const char STR_MAVLINK_SEND_POSITION[] = TR_MAVLINK_SEND_POSITION;
const char STR_MAVLINK_RC_OVERRIDE_16CH[] = TR_MAVLINK_RC_OVERRIDE_16CH;
ISTR(MAVLINK_SEND_POSITION_FREQUENCIES);
ISTR(MAVLINK_AUX_BAUDRATES);
const char STR_USB_MAVLINK[] = TR_USB_MAVLINK;

ISTR(MAVLINK_THROTTLE_WARNINGS);

const char STR_SERIAL_LABEL[] = TR_SERIAL_LABEL;
ISTR(USBMODES_OW);
ISTR(AUX_SERIAL_MODES_OW);
#endif
//OWEND
